...
const translations = {
    en: {
        ...
        "community-description": "We create welcoming spaces where students mentor each other, experiment with new ideas, and open doors for future technologists.",
        "community-list-1": "Launch peer-learning sessions that make tough courses easier together.",
        "community-list-2": "Co-design outreach workshops with schools and local partners.",
        "community-list-3": "Share research stories that highlight the impact of student projects.",
        "community-cta-primary": "Contact the TEP coordinators",
        "community-cta-secondary": "Meet our members",
        "community-highlight-title-1": "Peer Mentor Circles",
        "community-highlight-body-1": "Swap study tips, plan review labs, and help new students feel at home from day one.",
        "community-highlight-title-2": "Outreach Crew",
        "community-highlight-body-2": "Bring computing to local schools, youth centers, and public tech events across Småland.",
        "community-highlight-title-3": "Project Showcases",
        "community-highlight-body-3": "Curate demos and lightning talks that spotlight student research and creative builds.",
    ...
    sv: {
        ...
        "community-description": "Vi skapar välkomnande miljöer där studenter stöttar varandra, testar nya idéer och öppnar dörrar för framtidens teknologer.",
        "community-list-1": "Starta peer-learning-pass som gör svåra kurser enklare tillsammans.",
        "community-list-2": "Samskapa outreach-workshops med skolor och lokala partners.",
        "community-list-3": "Dela forskningsberättelser som visar effekten av studentprojekt.",
        "community-cta-primary": "Kontakta TEP-koordinatorerna",
        "community-cta-secondary": "Möt våra medlemmar",
        "community-highlight-title-1": "Mentor-cirklar",
        "community-highlight-body-1": "Byt studietips, planera repetitionslabb och hjälp nya studenter känna sig hemma från dag ett.",
        "community-highlight-title-2": "Outreach-teamet",
        "community-highlight-body-2": "Ta med programmering till skolor, ungdomscenter och offentliga tech-evenemang i Småland.",
        "community-highlight-title-3": "Projektvisningar",
        "community-highlight-body-3": "Kurera demos och lightning talks som lyfter studenters forskning och kreativa byggen.",
